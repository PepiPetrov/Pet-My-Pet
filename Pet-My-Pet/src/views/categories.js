import { filterByCategory, editArticle, getArticle } from "../api/data.js";
import { html } from '../../node_modules/lit-html/lit-html.js'

const template = (data, onLike, cat) => html`
...
export async function categories(ctx) {
    ...
    const data = Object.values(await filterByCategory(category))
    ctx.render(template(data,onLike,category))
